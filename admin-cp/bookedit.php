...
$sql_update="update books set title='$title',author='$author',category='$category',book_text='$book_text',cover_image='$ext',file_book='$extt' where id=" . $_GET['id'];

$result_insert=mysqli_query($conn,$sql_update);
                        ...
                        <div class="form-row py-4 pt-5">
                            <div class="offset-1 col-lg-10">
                                <input name="author" type="text" class="inp  px-3" placeholder="اسم المؤلف"
                                    style="margin-top:-150px;padding-top:-150px;">
                            </div>
                        </div>
